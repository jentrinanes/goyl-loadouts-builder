...
export const GEARS: Gear[] = [
  ...
  },
  {
    ...
    rarity: 'Epic',
    icon: '🪔',
    description: 'Incense crafted from medicinal herbs. The smoke slowly restores health to those who breathe it in.',
    stats: { attack: 0, defense: 10, health: 35, resolve: 10, stealth: 5, ranged: 0 },
    perk: 'Releases a small healing cloud on use',
    attributes1: ['Ghost Tool Damage', 'Tool Cooldown Reduction', 'All Ghost Tool Damage', 'Status Effect Duration', 'Spirit Gain On Kill', 'Tool Range Bonus'],
    attributes2: ATTR2_OPTIONS,
    attributes3: ['Soothing Smoke', 'Herbal Remedy', 'Lingering Mist'],
  },
  {
    ...
    rarity: 'Legendary',
    icon: '🕯️',
    description: 'Sacred incense purified by mountain shrine priests. The healing smoke mends wounds and cleanses afflictions.',
    ...
    attributes1: ['Ghost Tool Damage', 'Tool Cooldown Reduction', 'All Ghost Tool Damage', 'Status Effect Duration', 'Spirit Gain On Kill', 'Tool Range Bonus'],
    attributes2: ATTR2_OPTIONS,
    attributes3: ['Purifying Smoke', 'Sacred Healing', 'Cleansing Flame'],
  },
];
